  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'runtime/common/xwalk_hit_test_data.cc',
        'runtime/common/xwalk_hit_test_data.h',
        'runtime/common/xwalk_message_generator.cc',
        'runtime/common/xwalk_message_generator.h',
        'runtime/common/xwalk_messages.cc',
        'runtime/common/xwalk_messages.h',
        'runtime/common/xwalk_message_start.h',
